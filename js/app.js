...
function resetColors() {
    if (playerChoice != 0) {
        ...
        while (i < boxArray.length) {
                boxArray[i].style.background = "#B3ADB8";
                i++;
            }
        }
    }
...
// Sélection des éléments qui changent selon le darkmode/lightmode
const bodycolor = document.querySelector("body");
const consolecolor = document.querySelector(".console");
const togglemode = document.querySelector("#toggle");
const consoleBoxesColor = document.querySelector(".consoleBoxes");
const resetBttnColor = document.querySelector("#resetBttn");
const okBttnColor = document.querySelector(".validate");
const clearBttnColor = document.querySelector("#clearBttnBox");
const pickColors = document.querySelector(".pickColors");
const nbTurnColor = document.querySelector("#nb-turn");
const resultsColor = document.querySelector(".results");

// Fonction pour le darkmode/lightmode
toggle.onclick = function(){
    togglemode.classList.toggle('active');
    bodycolor.classList.toggle('active');
    consolecolor.classList.toggle('active');
    consoleBoxesColor.classList.toggle('active');
    resetBttnColor.classList.toggle('active');
    okBttnColor.classList.toggle('active');
    clearBttnColor.classList.toggle('active');
    pickColors.classList.toggle('active');
    nbTurnColor.classList.toggle('active');
    resultsColor.classList.toggle('active');    
}